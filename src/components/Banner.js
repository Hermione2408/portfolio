                ...
                <Row className='align-items-center'>
                    <Col xs={12} md={6} xl={7}>
                      ...
                      {({isVisible})=>
                        ...
                        <p>I enjoy solving complex problems and creating efficient, scalable code that delivers a great user experience. Whether you need a dynamic web application, a responsive website, or a robust API, I can help bring your vision to life. Let's build something amazing together!</p>
                        <button classname="myresume" onClick={() => window.open('https://drive.google.com/file/d/1VfYEa8FDFMZOavIxSuykv0NMDIZ7OoGP/view?usp=sharing')}>
  My Resume <ArrowRightCircle size={25}/>
</button>                   </div>}  
                   </TrackVisibility>
                   </Col>
                   <Col className="img-container" md={6} xl={5}>
                   <img src={headerImg} style={{ width:"35vw", height: "70vh" }} alt="Header Img" />
                   </Col >
                </Row>
            </Container>
        </section>
