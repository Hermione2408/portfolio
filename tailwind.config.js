  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        // 'serif': ['"Playfair Display"', 'serif'], // If you want to keep the 'serif' family as it is
        'serif': ['Poppins', 'sans-serif'], // This sets 'Montserrat' as the default sans-serif font
